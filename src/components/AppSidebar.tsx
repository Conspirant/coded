                        ...
                        {state !== "collapsed" && (
                          <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            {(item as any).isSpecial && (
                              <Badge variant="secondary" className="bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400 text-[10px] px-1.5 py-0.5 ml-auto">
                                ♥
                              </Badge>
                            )}
                          </div>
