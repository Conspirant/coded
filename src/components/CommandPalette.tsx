...
const COMMANDS: CommandItem[] = [
    ...
    { id: "blog", title: "Blog & Guides", description: "Counseling guides, Option Entry blueprints, and comparisons", icon: Book, href: "/blog", keywords: ["blog", "article", "guide", "counseling", "option entry", "choice 1 choice 2", "vtu autonomous"], category: "tools" },
