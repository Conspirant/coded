...
export default function NeetMatrixView() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-6 px-3 sm:px-6 lg:px-8 max-w-[1600px] mx-auto space-y-6">
      ...
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-2xl border border-rose-500/25 bg-gradient-to-r from-rose-950/40 via-card to-background p-6 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-rose-500/15 border border-rose-500/30 text-rose-400 text-[11px] font-semibold uppercase tracking-wider">
              ...
              Comprehensive Category Matrix Grid
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight font-brand text-foreground">
              Karnataka Medical <span className="text-rose-400">Cutoff Matrix</span>
            </h1>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <Download className="mr-1.5 h-3.5 w-3.5 text-rose-400" />
              Export Matrix CSV
            </Button>
